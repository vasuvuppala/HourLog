...
--   Created On : Wednesday, 07 October, 2015 
--   DBMS       : MySql 
--   -------------------------------------------------- 
...
(
	...
	version INTEGER UNSIGNED NOT NULL DEFAULT 0,
	accelerator BOOL NOT NULL DEFAULT TRUE COMMENT 'it is an accelerator  ',
...
(
	...
	last_serviced_at DATETIME COMMENT 'Time of last successful service',
...
(
	...
	updated_by INTEGER UNSIGNED COMMENT 'shift started by. can be null due to legacy data.',
...
ALTER TABLE shift ADD CONSTRAINT FK_shift_started_by 
	FOREIGN KEY (updated_by) REFERENCES sysuser (user_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;
