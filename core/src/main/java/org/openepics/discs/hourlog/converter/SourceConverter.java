...
public class SourceConverter implements Converter {
    ...
    private static final Logger logger = Logger.getLogger(SourceConverter.class.getName());
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (value == null || value.equals("")) {
            logger.log(Level.FINE, "source converter: empty id");
            return null;
        } else {
            object = hourLogEJB.findSource(Short.parseShort(value));
            return object;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            logger.log(Level.FINE, "source Converter: Null object");
            return "";
        } else {
            // logger.log(Level.FINE, "Exp number: " + ((Experiment) value).getId().toString());
            return ((Source) value).getSourceId().toString();
        }
    }
}
