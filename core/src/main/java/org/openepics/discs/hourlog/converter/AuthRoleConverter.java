...
public class AuthRoleConverter implements Converter {
    ...
    private static final Logger logger = Logger.getLogger(AuthRoleConverter.class.getName());
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (value == null || value.equals("")) {
            ...
            object = authEJB.findAuthRole(Integer.parseInt(value));
            return object;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((AuthRole) value).getRoleId().toString();
        }
    }
}
