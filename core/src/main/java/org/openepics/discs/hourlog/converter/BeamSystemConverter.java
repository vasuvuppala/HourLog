...
/**
 * Beam system converter
 *
 * @author vuppala
 */
@Named    // workaround for injecting an EJB in a converter
// @FacesConverter(value = "experimentConverter")
public class BeamSystemConverter implements Converter {

    @EJB
    private HourLogEJB hourLogEJB;
    private static final Logger logger = Logger.getLogger(BeamSystemConverter.class.getName());
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (value == null || value.equals("")) {
            logger.log(Level.FINE, "BeamSystem converter: empty id");
            return null;
        } else {
            object = hourLogEJB.findBeamSystem(Short.parseShort(value));
            return object;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((BeamSystem) value).getBeamSystemId().toString();
        }
    }
}
