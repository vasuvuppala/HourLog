...
public class BeamConverter implements Converter {

    @EJB
    private HourLogEJB hourLogEJB;
    private static final Logger logger = Logger.getLogger(BeamConverter.class.getName());
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (value == null || value.equals("")) {
            logger.log(Level.FINE, "Beam converter: empty id");
            return null;
        } else {
            object = hourLogEJB.findBeam(Short.parseShort(value));
            return object;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((Beam) value).getBeamId().toString();
        }
    }
}
