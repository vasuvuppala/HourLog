...
public class VaultConverter implements Converter {

    @EJB
    private HourLogEJB hourLogEJB;
    private static final Logger logger = Logger.getLogger(VaultConverter.class.getName());
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        if (value == null || value.equals("")) {
            ...
            object = hourLogEJB.findVault(Short.parseShort(value));
            return object;
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return ((Vault) value).getVaultId().toString();
        }
    }
}
