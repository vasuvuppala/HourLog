...
@NamedQueries({
    ...
    @NamedQuery(name = "ApiClient.findByPassKey", query = "SELECT a FROM ApiClient a WHERE a.passKey = :passKey"),
    ...
    @NamedQuery(name = "ApiClient.findByComment", query = "SELECT a FROM ApiClient a WHERE a.comment = :comment")})
public class ApiClient implements Serializable {
    ...
    public ApiClient(Integer id, String name, String passKey, String description, String contactName) {
        this.id = id;
        this.name = name;
